...
export const ProgramsCatalog = () => {
  ...
  useEffect(() => {
    programsService.getAll().then(setPrograms).finally(() => setLoading(false));
  }, []);
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', gap: 16 }}>
                        ...
                        {p.duration && <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: '0.7rem', color: C.subtle }}><Clock style={{ width: 11, height: 11 }} /> {p.duration} meses</span>}
                        <span style={{ fontSize: '0.7rem', color: C.subtle }}>{p.enrolled}/{p.capacity} inscritos</span>
                      </div>
                    </div>
